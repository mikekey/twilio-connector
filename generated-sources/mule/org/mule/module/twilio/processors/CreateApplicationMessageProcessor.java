...
/**
 * CreateApplicationMessageProcessor invokes the {@link org.mule.module.twilio.TwilioConnector#createApplication(java.lang.String, java.lang.String, java.lang.String, java.lang.String, org.mule.module.twilio.HttpMethod, org.mule.api.callback.HttpCallback, org.mule.api.callback.HttpCallback, java.lang.Boolean, java.lang.String, org.mule.module.twilio.HttpMethod, org.mule.api.callback.HttpCallback, org.mule.api.callback.HttpCallback)} method in {@link TwilioConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor
{
    ...
    /**
     * An HttpCallback instance responsible for linking the APIs http callback with the flow {@link org.mule.module.twilio.processors.CreateApplicationMessageProcessor#voiceFallbackCallbackFlow
     * 
     */
    ...
    /**
     * An HttpCallback instance responsible for linking the APIs http callback with the flow {@link org.mule.module.twilio.processors.CreateApplicationMessageProcessor#statusCallbackCallbackFlow
     * 
     */
    ...
    /**
     * An HttpCallback instance responsible for linking the APIs http callback with the flow {@link org.mule.module.twilio.processors.CreateApplicationMessageProcessor#smsFallbackCallbackFlow
     * 
     */
    ...
    /**
     * An HttpCallback instance responsible for linking the APIs http callback with the flow {@link org.mule.module.twilio.processors.CreateApplicationMessageProcessor#smsStatusCallbackCallbackFlow
     * 
     */
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedAccountSid = ((String) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_accountSidType").getGenericType(), null, accountSid));
            final String _transformedFriendlyName = ((String) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_friendlyNameType").getGenericType(), null, friendlyName));
            final String _transformedApiVersion = ((String) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_apiVersionType").getGenericType(), null, apiVersion));
            final String _transformedVoiceUrl = ((String) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_voiceUrlType").getGenericType(), null, voiceUrl));
            final HttpMethod _transformedVoiceMethod = ((HttpMethod) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_voiceMethodType").getGenericType(), null, voiceMethod));
            final Boolean _transformedVoiceCallerIdLookup = ((Boolean) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_voiceCallerIdLookupType").getGenericType(), null, voiceCallerIdLookup));
            final String _transformedSmsUrl = ((String) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_smsUrlType").getGenericType(), null, smsUrl));
            final HttpMethod _transformedSmsMethod = ((HttpMethod) evaluateAndTransform(getMuleContext(), event, CreateApplicationMessageProcessor.class.getDeclaredField("_smsMethodType").getGenericType(), null, smsMethod));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((TwilioConnector) object).createApplication(_transformedAccountSid, _transformedFriendlyName, _transformedApiVersion, _transformedVoiceUrl, _transformedVoiceMethod, voiceFallback, statusCallback, _transformedVoiceCallerIdLookup, _transformedSmsUrl, _transformedSmsMethod, smsFallback, smsStatusCallback);
                }
